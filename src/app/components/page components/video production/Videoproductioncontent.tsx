...
import { videoProductionAccordionData } from '../../../data/AllServiceData' 
...
const Videoproductioncontent = () => {
  ...
  const paragraphText = "Modern platforms prioritize rich, relevant content—especially video. Domain Dude combines scripting, visuals, and editing with marketing goals so each piece of content has a clear purpose in your funnel.";
        ...
        <section className={styles.sectionContent} ref={containerRef}>
            <div className={`${styles.container} container`}>
                 ...
                 <div className={styles.sectionHeader} ref={headerRef}>
                    ...
                    <h2>
                        ...
                        <span className={styles.highlight}>
                            {splitWordsH2("our video ")}
                        </span>
                        {splitWordsH2("and content ?")}
                    </h2>
                 ...
                 <div className={styles.accordion} ref={accordionRef}>
                    {videoProductionAccordionData.map((item) => (
