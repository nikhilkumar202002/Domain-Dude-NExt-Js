      ...
      <div className={`${styles.container} container`}>
        <div className={styles.content}>
          <div className={styles.header}>
            <h1 ref={headingRef}>
              {splitText("Video and content that stop the scroll and tell your story")}
            </h1>
            <p ref={paraRef}>
              Domain Dude produces brand films, social-first videos, and content that showcase your products, services, and story in a way that’s easy to understand and hard to ignore. The aim is to boost engagement and support both organic and paid campaigns.
            </p>
          </div>
