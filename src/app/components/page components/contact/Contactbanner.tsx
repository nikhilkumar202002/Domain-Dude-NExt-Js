...
const ContactBanner = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      .from(".contact-banner-header p", {
        y: 30,
        opacity: 0,
        duration: 1,
        ease: "power3.out",
      }, "-=0.8") // Overlap slightly
      .from(".contact-banner-cta", {
        y: 20,
        opacity: 0,
        duration: 1,
        ease: "power3.out",
      ...
      <div className="contact-banner-container container">
        <div className="contact-banner-content ">
          <div className="contact-banner-header">
            ...
            <p>
              Tell us a bit about your brand and goals, and the Domain Dude team will get back to you with ideas, timelines, and the best way to kickstart your next digital project.
            </p>
          </div>
