      ...
      <div className={`${styles.container} container`}>
        <div className={styles.content}>
          <div className={styles.header}>
            <h1 ref={headingRef}>
              {splitText("Branding that makes your business instantly recognizable")}
            </h1>
            <p ref={paraRef}>
             Domain Dude creates visual identities that look sharp, feel consistent, and communicate your brand’s personality across every touchpoint. From logo and color palette to typography and social templates, your brand is designed to be memorable and easy to use.
            </p>
          </div>
