...
import { digitalMarketingAccordionData } from '../../../data/AllServiceData' 
...
const DigitalMarketingContent = () => {
  ...
  const paragraphText = "MGreat campaigns start with clear goals and reliable tracking. Domain Dude sets up analytics, defines KPIs, and then tests creative, audiences, and landing pages so you can see exactly what’s working and where to scale.";
        ...
        <section className={Styles.sectionContent} ref={containerRef}>
            <div className={`${Styles.container} container`}>
                 ...
                 <div className={Styles.sectionHeader} ref={headerRef}>
                    <h2>
                        ...
                        <span className={Styles.highlight}>
                            {splitWordsH2("our digital ")}
                        </span>
                        {splitWordsH2("marketing ?")}
                    </h2>
                 ...
                 <div className={Styles.accordion} ref={accordionRef}>
                    ...
                    {digitalMarketingAccordionData.map((item) => (
