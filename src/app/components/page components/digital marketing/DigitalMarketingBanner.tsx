      ...
      <div className={`${styles.container} container`}>
        <div className={styles.content}>
          <div className={styles.header}>
            <h1 ref={headingRef}>
              {splitText("Digital marketing that drives traffic, leads, and sales")}
            </h1>
            <p ref={paraRef}>
             Domain Dude runs performance-focused digital marketing campaigns across search, social, and display to bring the right audience to your brand. Data-backed targeting, creative testing, and continuous optimization work together to lower your cost per lead and increase revenue from every channel.
            </p>
          </div>
