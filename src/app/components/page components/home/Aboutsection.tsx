...
import { useGSAP } from "@gsap/react"; // Ensure you have installed @gsap/react
...
const Aboutsection = () => {
  ...
  const contentRef = useRef(null); // Wrapper for exit animation
  ...
  useGSAP(() => {
    ...
    if (wrapper) gsap.set(wrapper, { backgroundColor: "#000000" });

    // 1. THEME TRANSITION: Set Background to BLACK, Text to WHITE
   if (contentRef.current) {
        gsap.to(contentRef.current, {
            ...
            scrollTrigger: {
                ...
                start: "bottom 60%", // Starts fading out when bottom of section is near middle of screen
                end: "bottom top",
                scrub: 1,
            }
        });
    }
    // 2. EXISTING ANIMATIONS (Migrated to useGSAP)
